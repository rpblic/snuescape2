...
def rserv_date(request, pk):
    ...
    rserv11_2= rservs.filter(rserv_date__hour= 11).filter(rserv_room= 2)
    rserv12_2= rservs.filter(rserv_date__hour= 12).filter(rserv_room= 2)
    rserv13_2= rservs.filter(rserv_date__hour= 13).filter(rserv_room= 2)
    rserv14_2= rservs.filter(rserv_date__hour= 14).filter(rserv_room= 2)
    rserv15_2= rservs.filter(rserv_date__hour= 15).filter(rserv_room= 2)
    rserv16_2= rservs.filter(rserv_date__hour= 16).filter(rserv_room= 2)
    rserv17_2= rservs.filter(rserv_date__hour= 17).filter(rserv_room= 2)
